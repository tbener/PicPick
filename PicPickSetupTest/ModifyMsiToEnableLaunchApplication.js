...
var filename = "PicPickUI.exe";                     // The name of the executable to launch - change * to match the file name you want to launch at the end of your setup
...
{
		WScript.Echo("Syntax: " + WScript.ScriptName + " file");
